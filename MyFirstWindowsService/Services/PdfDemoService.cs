namespace MyFirstWindowsService.Service
{
    ...
    public class PdfDemoService:IPDFDemoService
    {
        private readonly IConfiguration _configuration;
        private readonly IHostingEnvironment _hostingEnvironment;
        private readonly HttpClient _httpClient;
        private readonly IHttpContextAccessor _httpContextAccessor;
        public PdfDemoService(IHttpContextAccessor httpContextAccessor, IConfiguration configuration, HttpClient httpClient, IHostingEnvironment hostingEnvironment)
        {
        ...
        public string GenerateSummaryReportBySummaryDetailsAsync()
        {
            ...
            using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
            {
                ...
                PdfPCell keyFactsInfoData = new PdfPCell(new Phrase("Tony Stark\r\n", fontBody));
